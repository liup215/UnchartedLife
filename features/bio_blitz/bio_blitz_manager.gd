...
# UI References
@onready var quiz_panel: PanelContainer = $HUD/QuizPanel
@onready var question_label: Label = $HUD/QuizPanel/VBox/QuestionLabel
@onready var options_container: GridContainer = $HUD/QuizPanel/VBox/OptionsGrid
