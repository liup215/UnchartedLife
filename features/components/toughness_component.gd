...
func _trigger_stagger():
	...
	GameLogger.debug("toughness", "Toughness broken! Entering stagger state for %ss" % stagger_duration)
...
func _end_stagger():
	...
	GameLogger.debug("toughness", "Stagger ended, toughness restored to %s" % current_toughness)
